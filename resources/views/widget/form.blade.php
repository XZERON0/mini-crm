...
<body class="bg-gray-50">
    <div class="min-h-screen flex items-center justify-center p-4">
        <div class="w-full max-w-md bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden">
            <!-- Заголовок -->
            <div class="bg-linear-to-r from-blue-600 to-indigo-700 p-6">
            ...
            <form id="feedbackForm" class="p-6 space-y-4">
                ...
                <div>
                    ...
                    <div class="relative">
                        <div class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-blue-400 transition cursor-pointer bg-gray-50">
                            <input type="file" 
                                   name="files[]" 
                                   multiple 
                ...
                <button type="submit" 
                        id="submitBtn"
                        class="w-full bg-linear-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-semibold py-3 px-4 rounded-lg transition focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 mt-6">
                    Отправить заявку
                </button>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function showMessage(type, text) {
                messageDiv.className = `mx-6 mt-6 p-4 rounded-lg fade-in ${
                    type === 'success' 
